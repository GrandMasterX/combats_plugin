...
var SiteServices = function() {
	...
	this.contentHTML = '<div id="site_service_content">' +
					   '&nbsp<a href="javascript:void(0)" id="a_site_hide">(Скрыть)</a><div>';
	this.MenuItem		= function() {
		if (this.master != null && this.menuitem == null) {
			var This = this;
			...
			var menu_item = $('' +
							'&nbsp;<a target="_blank" href="http://old-mercenaries.ru/doska.html">События</a>' +
							'/<a target="_blank" href="http://old-mercenaries.ru/dressroom.html">Примерочная</a>' +
							'/<a target="_blank" href="http://old-mercenaries.ru/ruinmap.php">Карта Руин</a>' +
							'/<a></a>');
		...
		$.ajax({
			...
			success:function(data) {
				...
				if (res && res.length > 1) {
					...
					//This.user.id == 395988 /*-Эрика- - Глава клана*/||
...
var LabaPilotPl = function() {
	...
	this.contentHTML	= '<table id="auto_pilot" cellpadding="0"><tr valign="top">'+
						...
						'&nbsp;<a id="autodrop_log" href="javascript:void(0)">Лог</a> &nbsp;(<a id="autodrop_log_clear" href="javascript:void(0)">Очистить лог</a>).'+
						'&nbsp;&nbsp;||&nbsp;&nbsp;<a id="map_open" title="HotKey - M(лат.)" href="javascript:void(0)">Карта</a>'+
