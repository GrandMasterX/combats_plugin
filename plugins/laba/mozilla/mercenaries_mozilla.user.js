// ==UserScript==
// @name		    Mercenaries plugin collection
// @namespace		http://old-mercenaries.ru/
// @description		Панель плагинов для OldBK от клана Mercenaries
// @version		    1.1
	...
	function ready() {
        if (!called) {
            ...
            if (document.URL.indexOf("Default12345.aspx") != -1 || document.URL.indexOf("/battle.php") != -1) {
                ...
                js_raise_event.setAttribute("src", "http://old-mercenaries.ru/plugins/laba/mozilla/LoadEvent.js?");
